...
//     console.warn(document_front_picture,theFile,"nnnnnnnnnnnnnnnnnnnnnnmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm")
//   }
...
//       console.log(attributeName, "JJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJjJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJJ");
...
//         console.warn("")
//         const updatedData = {
//           ...frontFileData,
...
//           }),
//         };
//         console.warn(updatedData,attributeName,attributeValue,"")
...
//         (backFileData && backFileData?.names && backFileData?.names[attributeName])
//       ) {
//         console.warn("")
...
//         (backFileData && backFileData?.extractedIdNumbers && backFileData?.extractedIdNumbers[attributeName])
//       ) {
//         console.warn("")
...
//         (backFileData && backFileData?.dates && backFileData?.dates[selectedDoc+'expiryDate'])
//       ) {
//         console.warn("")
...
//       ) {
//         console.warn("")
...
//       documentDetails =['/id_card.png','EmiratesId', '/passport.png','Passport', '/visa.png','Visa', '/driver-license.png','Lisense','/blank-document.jpg','Other']
//     }else{
...
//   fetchDocumentData();
// }, []);
// console.warn(documentUploadStatus,fileData,"IIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII",isAnyDocumentUploading,"KKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFfFFFFFFFffffff")
...
//                   key={index}
//                   className={`no-scrollbar h-26 items-center  justify-center max-w-[100px] overflow-hidden rounded-2xl hover:ring-offset-2 hover:ring-2 bg-[color:var(--mainTitleLightestColor)] ${
//                     document.frontUploaded && document.backUploaded ? 'pointer-events-none opacity-60' : ''
//                   } ${selectedDoc === document.name ? 'bg-[color:var(--primaryColor)] text-white' : ''}`}
...
//                   { (!captureMethod && !documentUploadStatus[index].frontUploaded && !fileData) || (fileData?.documents && !fileData?.documents.find((doc: any) => doc.document_name === selectedDoc)?.front_image) ? (
//                     <>
...
//                                       ref={commonInputRef}
//                                       defaultValue={
//                                         (fileData?.documents.find((doc: any) => doc.document_name === "EmiratesId")?.attributes?.name) ||
...
//                                       ref={commonInputRef}
//                                       defaultValue={
//                                         ( fileData?.documents.find((doc: any) => doc.document_name === selectedDoc)?.document_id) ||
...
//                                         ( fileData?.documents.find((doc: any) => doc.document_name === selectedDoc)?.expiry) ||
...
//                                       ref={commonInputRef}
//                                       defaultValue={
//                                         (fileData?.documents.find((doc: any) => doc.document_name === selectedDoc)?.attributes?.dateOfBirth) ||
...
//                                       ref={commonInputRef}
//                                       defaultValue={
//                                         (fileData?.documents.find((doc: any) => doc.document_name === selectedDoc)?.attributes?.employer) ||
...
//                                       ref={commonInputRef}
//                                       defaultValue={
//                                         ( fileData?.documents.find((doc: any) => doc.document_name === selectedDoc)?.attributes?.occupation) ||
  ...
  const changeDocumentBackPicture = async(file:File) => {
    ...
    const handleAttributeChange = async (attributeName: string, attributeValue: string) => {
      ...
      if (fileData?.documents && fileData?.documents.find((doc: any) => doc.document_name === "EmiratesId")) {
        ...
        console.warn(updatedData,"")
    ...
    const collectDocumentData = (docType: string) => {
      ...
      console.warn("GGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG")
      return dataToCollect;
    };
    ...
    const handleSubmit = async () => {
      try {
        // Collect data for the selected document
        const documentData = collectDocumentData(selectedDoc);
        console.warn(documentData,uploadedImages[selectedDoc]?.frontImage,selectedDoc,"KKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKK")
        const frontImage = uploadedImages[selectedDoc]?.frontImage || fileData?.documents && fileData?.documents.find((doc: any) => doc.document_name === selectedDoc)?.front_image||'';
        const backImage = uploadedImages[selectedDoc]?.backImage || fileData?.documents && fileData?.documents.find((doc: any) => doc.document_name === selectedDoc)?.back_image|| '';
        // const values = getCurrentValues();
        console.warn(frontImage,backImage,"Jhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvhhhhhhhhhh")
        // Construct the updatedFormValues with the documentData array properly iterated
        const updatedFormValues = {
          user_id: userId, // Assuming userId is accessible in this scope
          is_personel_document: true, // Assuming it's always a personal document
