    ...
    <div className='no-scrollbar'>
      ...
      <div className="hidden sm:flex justify-between items-center font-bold w-full h-auto bg-[color:var(--primaryColor)] no-scrollbar">
        <div className="flex ml-6 p-4 space-x-20">
          ...
          <button className='ring-2 m-2 p-2 pl-2 pr-2 ring-white text-white shadow-mg rounded-xl hover:bg-white hover:text-[color:var(--primaryColor)] flex items-center justify-center gap-x-2 hover:scale-105 duration-100' onClick={onVshareClick} ><FontAwesomeIcon icon={faFolderOpen}/> Folder Link Generate</button>
        ...
        <div className='w-[510px] max-auto p-4'>
          <div className='flex items-center justify-center gap-x-6 text-white'>
            {!isUserLoggedIn() ? (
              <>
                <Link href="/contact">
                  <button className='hover:ring-2 m-2 p-2 ring-white shadow-mg rounded-xl hover:bg-white hover:text-[color:var(--primaryColor)] hover:scale-105 duration-100' >Contact</button>
                </Link>
                <Link href="/about">
                  <button className='hover:ring-2 m-2 p-2 ring-white shadow-mg rounded-xl hover:bg-white hover:text-[color:var(--primaryColor)] hover:scale-105 duration-100' >About</button>
                </Link>
                <button className='ring-2 m-2 p-2 pl-4 pr-4 ring-white shadow-mg rounded-xl hover:bg-white hover:text-[color:var(--primaryColor)] hover:scale-105 duration-100'onClick={onLoginClick}>Login</button>
                
                <button className='ring-2 m-2 p-2 pl-2 pr-2 ring-white shadow-mg rounded-xl hover:bg-white hover:text-[color:var(--primaryColor)] hover:scale-105 duration-100' onClick={onRegisterClick}>Register</button>
              ...
              <button onClick={handleDashboard} className='flex items-center hover:bg-red-200 justify-center gap-x-2 text-red-500 bg-red-100 p-2 pl-10 pr-10 rounded-xl font-semibold hover:scale-110 duration-100'>
