...
// import { FaEdit, FaTrash, FaImage, FaArrowLeft, FaFolder, FaCalendarDay, FaMoneyBillAlt, FaStar, FaQrcode, FaPen, FaToolbox } from "react-icons/fa";
...
// import { faPerson, faQrcode, faStar } from "@fortawesome/free-solid-svg-icons";
...
//     console.warn(`QR code decoded2222222222222222222222222222222222222222222222222222222222222222222: ${decodedText}`);
//     setQrResult(decodedText);
//     qrCodeScannerRef.current?.clear();
//   };

//   const qrCodeErrorCallback = (errorMessage: string) => {
//     console.warn(`QR Code scan error1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111: ${errorMessage}`);
//   };
...
//     <div className="p-m flex flex-col gap-m items-center">
//       <div id={scannerId} className="rounded-s shadow-m"></div>
//       <button onClick={running ? stopScanner : startScanner}>
...
// //       <CommonAddButton
// //         icon={faPerson}
// //         color="bg-[color:var(--primaryColor)] text-white font-medium justify-center m-2 rounded-xl shadow-md hover:bg-white hover:text-gray-400" // Add your desired color here
...
// //             <h1  onClick={openPopupPersonel} className="flex items-center justify-center bg-white border-2 border-gray-200 text-sm m-2 p-2 rounded-xl font-medium text-[color:var(mainTitleLightestColor)] text-xl">Documents</h1>
...
// //               <CommonSalary children={undefined}/>
// //               </div>
// //           </CommonPopup>
